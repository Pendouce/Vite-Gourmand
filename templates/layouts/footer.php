    ...
    <footer class="bg-fond-nav p-8 text-texte text-sm lg:text-lg">

      <?php /** @var object $infos */ ?>
      <div class="w-full flex flex-col items-center gap-8 lg:flex-row lg:items-center">
        
        <!-- Logo -->
        <div class="flex justify-start items-center order-2 lg:order-0">
          <img class="h-15 w-25 lg:h-30 lg:w-50 object-cover" src="/asset/images/logo.png" alt="logo vite et gourmand">
        </div>
        <div class="w-full">
          <!-- Horaires -->
          <div class="grid grid-cols-2 lg:grid-cols-3 mb-8 gap-4 lg:gap-8 w-full">
            ...
            <!-- Adresse -->
            <div class="flex flex-col order-3 lg:col-span-1 lg:order-0 justify-center col-span-2 items-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="m-4 size-6">
            ...
            <!-- Contact -->
            <div class="flex flex-col order-2 lg:order-0 items-center">
